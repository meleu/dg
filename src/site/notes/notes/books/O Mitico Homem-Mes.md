---
{"dg-publish":true,"permalink":"/notes/books/o-mitico-homem-mes/"}
---
...
- Ter sempre em mente que **Gestão da Complexidade** deve ser o imperativo técnico primário do software ([[notes/books/code-complete/Code Complete\|Code Complete]]).
