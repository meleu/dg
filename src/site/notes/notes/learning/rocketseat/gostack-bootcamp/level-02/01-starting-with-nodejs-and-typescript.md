---
{"dg-publish":true,"permalink":"/notes/learning/rocketseat/gostack-bootcamp/level-02/01-starting-with-nodejs-and-typescript/"}
---
...
# copy the packages shown on the question 9 except 'eslint@^5.16.0 ||
{ #6}
.8.0'
# because we already have it, and remove 1.7.0 from
# 'eslint-plugin-react-hooks@^2.5.0 ||
{ #1}
.7.0'. The command will become like this:
